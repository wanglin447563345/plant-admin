...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/center/dashboard': {
      component: dynamicWrapper(app, ['global','dashboard'], () => import('../routes/Dashboard/Analysis')),
    },
    '/center/user': {
    ...
    '/center/list': {
      component: dynamicWrapper(app, ['global','plant_list'], () => import('../routes/List/PlantList')),
    },
    '/center/warning': {
